...
Este proyecto contiene un ejercicio de tareas usando *React* con props, useState y demas funcionalidades que puedes encontrar en el repo, este ejercicio esta listo para copiar o realizar ✅
...
- Para poder clonarlo usamos git con el comando
 ```
git clone https://github.com/MtAgia/tpReact_4.git
 ```